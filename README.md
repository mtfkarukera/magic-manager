...
- 🗑️ **Suppression en ligne & par lot** — Supprimez des sources individuellement ou par lot, ainsi que les notes et artéfacts du Studio, directement depuis l'interface (avec garde anti-homonymes de sécurité pour le Studio).
...
> ⚠️ **Limitation de la suppression par lot (Studio)** : Afin d'éviter toute suppression involontaire due à l'ambiguïté des noms, la suppression par lot est bloquée si un ou plusieurs éléments sélectionnés partagent leur nom avec d'autres éléments présents dans le Studio. Veuillez les renommer ou les supprimer individuellement.
