...
- ✨ **Restitution sur les Notes Figées** : Suppression du blocage global `.studio-panel` pour réautoriser l'application des superbes boîtes de code `mm-code-block` sur les notes en lecture seule.
