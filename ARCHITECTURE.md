...
- **Persistance de Sélection et Actions Batch (v0.9.0)** :
  ...
  - **Invalidation post-viewer (wasViewing)** : L'extension détecte la fermeture du note viewer (lorsque la Garde 2 redevient fausse) et invalide immédiatement le cache local de studio-delete, forçant un rafraîchissement RPC asynchrone pour réaligner les IDs au cas où une note aurait été éditée et déplacée dans l'ordre chronologique.
